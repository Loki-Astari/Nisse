...
{
    ThorsAnvil::Nisse::PyntHTTP::HeaderRequest     header{};
}
...
{
    ThorsAnvil::Nisse::PyntHTTP::HeaderRequest     headerBase;
    ThorsAnvil::Nisse::PyntHTTP::HeaderRequest const& header = headerBase;
