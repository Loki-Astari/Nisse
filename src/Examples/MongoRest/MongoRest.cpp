...
class MongoRest: public NisServer::NisseServer
{
    ...
    void sendPage(NisHttp::Request const& request, NisHttp::Response& response)
    {
        std::error_code ec;
    ...
    public:
            ...
            , contentDir{contentDir}
        {
            ...
            http.addPath(NisHttp::Method::POST,   "/person/",        [&](NisHttp::Request const& request, NisHttp::Response& response) {mongoServer.personCreate(request, response);return true;});
            http.addPath(NisHttp::Method::GET,    "/person/Id-{id}", [&](NisHttp::Request const& request, NisHttp::Response& response) {mongoServer.personGet(request, response);return true;});
            http.addPath(NisHttp::Method::PUT,    "/person/Id-{id}", [&](NisHttp::Request const& request, NisHttp::Response& response) {mongoServer.personUpdate(request, response);return true;});
            http.addPath(NisHttp::Method::DELETER,"/person/Id-{id}", [&](NisHttp::Request const& request, NisHttp::Response& response) {mongoServer.personDelete(request, response);return true;});

            // Search Person Interface
            http.addPath(NisHttp::Method::GET,    "/person/findByName/{first}/{last}",[&](NisHttp::Request const& request, NisHttp::Response& response) {mongoServer.personFindByName(request, response);return true;});
            http.addPath(NisHttp::Method::GET,    "/person/findByTel/{tel}",          [&](NisHttp::Request const& request, NisHttp::Response& response) {mongoServer.personFindByTel(request, response);return true;});
            http.addPath(NisHttp::Method::GET,    "/person/findByZip/{zip}",          [&](NisHttp::Request const& request, NisHttp::Response& response) {mongoServer.personFindByZip(request, response);return true;});

            // WebInterface
            http.addPath(NisHttp::Method::GET,    "/{page}",         [&](NisHttp::Request const& request, NisHttp::Response& response) {sendPage(request, response);return true;});
